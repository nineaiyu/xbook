    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover', models.CharField(blank=True, max_length=512, null=True, verbose_name='书籍封面')),
                ...
                ('categories', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='categories', to='api.booklabels', verbose_name='书籍类别')),
                ('file', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='api.aliyunfileinfo', verbose_name='存储信息')),
                ('owner_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='所属用户')),
                ('tags', models.ManyToManyField(blank=True, null=True, related_name='tags', to='api.booklabels', verbose_name='书籍标签')),
            ],
            options={
                'verbose_name': '书籍信息',
