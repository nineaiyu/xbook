...
from common.libs.alidrive.error import AligoStatus500
...
class Auth(object):
    ...
    def __init__(
        ...
        self._request_failed_delay = 3
        self._requests_timeout = None
    ...
    def _create_session(self):
        self.post(USERS_V1_USERS_DEVICE_CREATE_SESSION, body={
            'deviceName': f'xbook - {self.drive_obj.nick_name}',
